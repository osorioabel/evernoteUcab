                    ...
                    <div id="projects-list">
                        ...
                        if (isset($records)):
                            ...
                            foreach ($records as $c):
                                ...
                                $ref = base_url() . 'libreta/indexSelectConsulta/' . $username . '/' . $c->id_libreta . '>';
                                $ref2 = base_url() . 'nota/SelectNoteConsulta/' . $username . '/' . $c->id_libreta;

                                echo form_open('/libreta/indexSelectConsulta/' . $username . '/' . $c->nombre, $attributes);
                                ?>
                                <div class='project'>
