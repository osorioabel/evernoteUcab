    ...
    <div class="wrapper">
        ...
        <div id="content">
                ...
                echo form_open('/Home/verifylogin',$attributes); ?>
                    <fieldset>
                        <div>
                            ...
                            <input name="username_login"  id="username_login" type="text" class="form-poshytip" title="Enter a username" />
                        </div>
                        <div>
            ...
            <div class="one-half last">
                ...
                <?php 
                $attributes2 = array('id' => 'contactForm');
                echo form_open('/Home/register',$attributes2); ?>
                    <fieldset>
                        ...
                        <div>
                            ...
                            <input name="dropboxmail_signup"  id="dropboxmail_signup" type="username_signup" class="form-poshytip" title="Enter your Dropbox User" />
                        </div>
                        <div>
